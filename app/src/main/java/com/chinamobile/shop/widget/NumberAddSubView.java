...
public class NumberAddSubView extends LinearLayout implements View.OnClickListener {
    ...
    public NumberAddSubView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if(attrs !=null){
            ...
            Drawable etBackground = a.getDrawable(R.styleable.NumberAddSubView_textViewBackground);
            if(etBackground!=null)
                setEditTextBackground(etBackground);


             Drawable buttonAddBackground = a.getDrawable(R.styleable.NumberAddSubView_btnAddBackground);
             if(buttonAddBackground!=null)
                 setButtonAddBackgroud(buttonAddBackground);

            Drawable buttonSubBackground = a.getDrawable(R.styleable.NumberAddSubView_btnSubBackground);
    ...
    private void initView(){
        ...
        mEtxtNum = (TextView) view.findViewById(R.id.text_number);
